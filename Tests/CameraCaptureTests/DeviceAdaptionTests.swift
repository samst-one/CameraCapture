...
class AdaptionTests: XCTestCase {
    ...
    func testScaleToMultiplication() {
        ...
        XCTAssertEqual(ZoomScaleToMultiplication.adapt(deviceType: .wideAngleCamera, scale: 2), 1)
    }
    ...
    func testMultiplicationToScale() {
        ...
        XCTAssertEqual(ZoomMultiplcationToScale.adapt(deviceType: .wideAngleCamera, multiplier: 2), 4)
    }
